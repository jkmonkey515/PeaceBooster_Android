...
public final class ItemVideoBinding implements ViewBinding {
  ...
  private ItemVideoBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivShare,
      @NonNull ImageView ivThumbnail, @NonNull TextView tvDescription) {
  ...
  public static ItemVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemVideoBinding((ConstraintLayout) rootView, ivShare, ivThumbnail, tvDescription);
    }
