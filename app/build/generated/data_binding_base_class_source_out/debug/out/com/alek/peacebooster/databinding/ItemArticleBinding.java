...
public final class ItemArticleBinding implements ViewBinding {
  ...
  private ItemArticleBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivShare,
  ...
  public static ItemArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemArticleBinding((ConstraintLayout) rootView, ivShare, tvContent, tvTitle);
    }
